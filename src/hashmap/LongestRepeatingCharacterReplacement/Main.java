package hashmap.LongestRepeatingCharacterReplacement;
...
public class Main {
    public static void main(String[] args) {
        Main main = new Main();
        System.out.println(main.characterReplacement("AABBBBAAAA", 3)); // 7
        System.out.println(main.characterReplacement("AABBBBAAAA", 2)); // 6
        System.out.println(main.characterReplacement("AABBBBAAAA", 4)); // 10
        System.out.println(main.characterReplacement("ABAB", 2)); // 4
        System.out.println(main.characterReplacement("AABABBA", 1)); // 4
        System.out.println(main.characterReplacement("AABA", 0)); // 2
        System.out.println(main.characterReplacement("ABAA", 0)); // 2
        System.out.println(main.characterReplacement("BAAA", 0)); // 3
    }
