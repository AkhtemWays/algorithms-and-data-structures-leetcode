...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        char[][] board3 = {{'A', 'B'}, {'C', 'D'}};
        Main main = new Main();
        System.out.println(main.exist(board, "SEE"));
        System.out.println(main.exist(board, "ABAB"));
        System.out.println(main.exist(board, "ABCCED"));
        System.out.println(main.exist(board2, "A"));
        System.out.println(main.exist(board3, "CDBA"));
    }
