package math.MinimumAreaRectangle2;
...
public class Main {
    public static void main(String[] args) {
        Main main = new Main();
        int[][] points1 = {{1,2},{2,1},{1,0},{0,1}}; // 2
        int[][] points2 = {{0,3},{1,2},{3,1},{1,3},{2,1}}; // 0
        int[][] points3 = {{0,1},{2,1},{1,1},{1,0},{2,0}}; // 1
        System.out.println(main.minAreaFreeRect(points1));
        System.out.println(main.minAreaFreeRect(points2));
        System.out.println(main.minAreaFreeRect(points3));
    }
